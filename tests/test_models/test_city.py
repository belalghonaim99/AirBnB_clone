#!/usr/bin/python3
"""
Defines unittests for the City class in the models directory.
...
class TestCityInstantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("'created_at': " + datetime_repr, city_str)
        self.assertIn("'updated_at': " + datetime_repr, city_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        city_instance = City(id="345", created_at=datetime_iso, updated_at=datetime_iso)
